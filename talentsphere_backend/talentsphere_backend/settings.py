"""
Django settings for talentsphere_backend project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'testserver', 'stujya.site', 'www.stujya.site', 'stujya.onrender.com', 'https://stujya.site']
...
ROOT_URLCONF = "talentsphere_backend.urls"
...
WSGI_APPLICATION = "talentsphere_backend.wsgi.application"
